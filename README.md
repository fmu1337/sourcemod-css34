...
| `sm13-dev` | **1.13.0.7472** (`6eb5f8f…`) | **1.12 git1224** | DEV (default) |
| `sm13-mm20` | 1.13.0.7472 | **2.0 git1469** (KHook `fa6f80e…`) | Experimental |
...
| [`1.13.0.7472-mm1.12.0`](https://github.com/fmu1337/sourcemod-css34/releases/tag/1.13.0.7472-mm1.12.0) | `sm13-dev` | 1.13.0-git7472 | 1.12.0-dev+1224 | CI smoke + botplay matrix |
| [`1.13.0.7472-mm2.0.1`](https://github.com/fmu1337/sourcemod-css34/releases/tag/1.13.0.7472-mm2.0.1) | `sm13-mm20` | 1.13.0-git7472 | 2.0.0-dev+1469 | CI smoke + botplay matrix |
...
git tag 1.13.0.7472-mm1.12.0   # sm13-dev
git tag 1.13.0.7472-mm2.0.1    # sm13-mm20
