...
keep_gamedata=(
  ...
  core.games/blocklist.plugins.txt
...
echo "==> Installing GeoLite2-Country database for GeoIP extension"
geoip_dir="$SM_ROOT/configs/geoip"
mkdir -p "$geoip_dir"
chmod +x "$BUILDER_DIR/download-geolite2.sh"
"$BUILDER_DIR/download-geolite2.sh" "$geoip_dir/GeoLite2-Country.mmdb"
